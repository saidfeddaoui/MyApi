var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({
                url: Routing.generate('content_types_produit_contrat_delete', {id: id}),
                type: "POST",
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                /* save data backend */
                var id = tr.data('id');
                var saveUrl = Routing.generate('content_types_produit_contrat_add');
                if (id) {
                    var saveUrl = Routing.generate('content_types_produit_contrat_edit', {id: id});
                }
