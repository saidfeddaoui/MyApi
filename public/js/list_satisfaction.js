var TableDatatablesEditable = function () {
    var handleTable = function () {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({
                url: Routing.generate('devis_delete_list-satisfaction', {id: id}),
                type: "POST",
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                /* save data backend */
                var id = tr.data('id');
                var saveUrl = Routing.generate('devis_add_list-satisfaction');
                if (id) {
                    saveUrl = Routing.generate('devis_edit_list-satisfaction', {id: id});
                }
