var TableDatatablesEditable = function () {
    var handleTable = function () {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({
                url: Routing.generate('content_types_delete_accident', {id: id}),
                type: "POST",
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                /* save data backend */
                var id = tr.data('id');
                var saveUrl = Routing.generate('content_types_add_accident');
                if (id) {
                    var saveUrl = Routing.generate('content_types_edit_accident', {id: id});
                }
                var name = tr.find('td .name').val();
                var name_ar = tr.find('td .name_ar').val();
                var DATA = {"type":name,"type_ar":name_ar};
                $.ajax({
                    url: saveUrl,
                    type: "POST",
                    data:DATA,
