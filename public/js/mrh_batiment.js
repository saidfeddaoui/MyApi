var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            var aData = oTable.fnGetData(nRow);
            var jqTds = $('>td', nRow);
            jqTds[0].innerHTML = '<input type="text" class="form-control input-small value" value="' + aData[0] + '">';
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({
                url: Routing.generate('content_types_delete_batiment', {id: id}),
                type: "POST",
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                /* save data backend */
                var id = tr.data('id');
                var saveUrl = Routing.generate('content_types_add_batiment');
                if (id) {
                    var saveUrl = Routing.generate('content_types_edit_batiment', {id: id});
                }
                var value = tr.find('td .value').val();
