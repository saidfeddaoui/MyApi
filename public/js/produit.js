var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[1].innerHTML = '<input type="file" class="form-control input-small tilde-image" value="' + aData[1] + '">';
            jqTds[2].innerHTML = '<input type="file" class="form-control input-small tilde-icon" value="' + aData[2] + '">';
            jqTds[3].innerHTML = '<a class="edit" id="Save" href="">Enregister</a>';
